 ...
 * {@link DtvItemTouchHelper.Callback} class or implementing {@link DtvItemTouchHelper.ViewDropHandler}
 ...
 */
public class DtvItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     */
    public DtvItemTouchHelper(Callback callback) {
        mCallback = callback;
    }
     ...
     * {@link DtvItemTouchHelper.Callback#isLongPressDragEnabled()}.
     * <p>
     ...
     * ItemTouchHelper
     * is attached.</li>
     * <li>{@link DtvItemTouchHelper.Callback} must have dragging enabled.</li>
     ...
     *                   RecyclerView.
     * @see DtvItemTouchHelper.Callback#isItemViewSwipeEnabled()
     */
     ...
     * behavior
     * by overriding {@link DtvItemTouchHelper.Callback}
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * ItemTouchHelper is attached.</li>
     * <li>{@link DtvItemTouchHelper.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the ItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events, this should work as expected.</li>
     * </ul>
     ...
     * {@link DtvItemTouchHelper}.
     */
    public static interface ViewDropHandler {

        /**
         * Called by the {@link DtvItemTouchHelper} after a View is dropped over another View.
         * <p>
    ...
    public abstract static class Callback {
         ...
         *                    it is cleared.
         * @param actionState One of {@link DtvItemTouchHelper#ACTION_STATE_IDLE},
         *                    {@link DtvItemTouchHelper#ACTION_STATE_SWIPE} or
         *                    {@link DtvItemTouchHelper#ACTION_STATE_DRAG}.
        ...
        void onDraw(Canvas c, RecyclerView parent, ViewHolder selected,
                    List<DtvItemTouchHelper.RecoverAnimation> recoverAnimationList,
                    int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
                final DtvItemTouchHelper.RecoverAnimation anim = recoverAnimationList.get(i);
                anim.update();
